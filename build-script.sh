...
git apply ../contrib/test-patches/temp-revert-1.patch
git apply ../contrib/test-patches/temp-revert-2.patch
git apply ../contrib/test-patches/temp-revert-3.patch
git apply ../contrib/test-patches/temp-revert-4.patch
git apply ../contrib/test-patches/bitcoind-comparison.patch
...
/mnt/mingw/qt/src/bin/qmake -spec unsupported/win32-g++-cross BITCOIN_QT_TEST=1 PROTOBUF_LIB_PATH=/mnt/mingw/protobuf-2.5.0 PROTOBUF_INCLUDE_PATH=/mnt/mingw/protobuf-2.5.0/src PROTOC=/mnt/mingw/protobuf-2.5.0/protoc MINIUPNPC_LIB_PATH=/mnt/mingw/miniupnpc/ MINIUPNPC_INCLUDE_PATH=/mnt/mingw/ BDB_LIB_PATH=/mnt/mingw/db-4.8.30.NC/build_unix/ BDB_INCLUDE_PATH=/mnt/mingw/db-4.8.30.NC/build_unix/ BOOST_LIB_PATH=/mnt/mingw/boost_1_50_0/stage/lib BOOST_INCLUDE_PATH=/mnt/mingw/boost_1_50_0/ BOOST_LIB_SUFFIX=-mt-s BOOST_THREAD_LIB_SUFFIX=_win32-mt-s OPENSSL_LIB_PATH=/mnt/mingw/openssl-1.0.1b OPENSSL_INCLUDE_PATH=/mnt/mingw/openssl-1.0.1b/include/ QRENCODE_LIB_PATH=/mnt/mingw/qrencode-3.2.0/.libs QRENCODE_INCLUDE_PATH=/mnt/mingw/qrencode-3.2.0 USE_QRCODE=1 INCLUDEPATH=/mnt/mingw DEFINES=BOOST_THREAD_USE_LIB BITCOIN_NEED_QT_PLUGINS=1 QMAKE_LRELEASE=lrelease USE_BUILD_INFO=1 QMAKE_MOC=/mnt/mingw/qt/src/bin/moc QMAKE_UIC=/mnt/mingw/qt/src/bin/uic
make -j6
./release/bitcoin-qt_test.exe
mv release/bitcoin-qt_test.exe out/

make clean
/mnt/mingw/qt/src/bin/qmake -spec unsupported/win32-g++-cross PROTOBUF_LIB_PATH=/mnt/mingw/protobuf-2.5.0 PROTOBUF_INCLUDE_PATH=/mnt/mingw/protobuf-2.5.0/src PROTOC=/mnt/mingw/protobuf-2.5.0/protoc MINIUPNPC_LIB_PATH=/mnt/mingw/miniupnpc/ MINIUPNPC_INCLUDE_PATH=/mnt/mingw/ BDB_LIB_PATH=/mnt/mingw/db-4.8.30.NC/build_unix/ BDB_INCLUDE_PATH=/mnt/mingw/db-4.8.30.NC/build_unix/ BOOST_LIB_PATH=/mnt/mingw/boost_1_50_0/stage/lib BOOST_INCLUDE_PATH=/mnt/mingw/boost_1_50_0/ BOOST_LIB_SUFFIX=-mt-s BOOST_THREAD_LIB_SUFFIX=_win32-mt-s OPENSSL_LIB_PATH=/mnt/mingw/openssl-1.0.1b OPENSSL_INCLUDE_PATH=/mnt/mingw/openssl-1.0.1b/include/ QRENCODE_LIB_PATH=/mnt/mingw/qrencode-3.2.0/.libs QRENCODE_INCLUDE_PATH=/mnt/mingw/qrencode-3.2.0 USE_QRCODE=1 INCLUDEPATH=/mnt/mingw DEFINES=BOOST_THREAD_USE_LIB BITCOIN_NEED_QT_PLUGINS=1 QMAKE_LRELEASE=lrelease USE_BUILD_INFO=1 QMAKE_MOC=/mnt/mingw/qt/src/bin/moc QMAKE_UIC=/mnt/mingw/qt/src/bin/uic
make -j6
